...
(function ($, App) {
     ...
     * @constructor
     */
    function NotificationList(selector){
        var self = this;
     ...
     * @private
     */
    NotificationList.prototype._init = function() {
        var self = this;
    ...
    /**
     * Assign events on the widget, deligate on the root element
     * @private
     */
    NotificationList.prototype._assignEvents = function(){
        var self = this;
     ...
     * @private
     */
    NotificationList.prototype._onClickToggleShow = function(e){
        this.togglePopup();
     ...
     * @private
     */
    NotificationList.prototype._onClickLoadNotification = function(e){
        e.preventDefault();
     ...
     * @private
     */
    NotificationList.prototype._renderNotification = function(notifList){
        var self = this;
     ...
     * @private
     */
    NotificationList.prototype._filterOnlyNew = function(notifList){
     ...
     * @param {Number} offset -
     */
    NotificationList.prototype.loadNotification = function(offset){
        var self = this;
    ...
    // transport
    NotificationList.prototype._recieveUnreadCount = function(){
        var defer = $.Deferred(),
    ...
    NotificationList.prototype._recieveNotification = function(offset){
        var defer = $.Deferred(),
            limit = 5,
            url = jsRoutes.controllers.core.Notifications.list(offset, limit).url;
     ...
     * @private
     */
    NotificationList.prototype._sendViewedNewNotif = function(notifList){
        var ids = [],
...
(function ($, App) {
    ...
    /**
     * Assign events on inputs and textarea
     */
    FormValidation.prototype.assignEvents = function(){
        var self = this;

        self.$inputs.on('input', function(e){
     ...
     * @returns {boolean}
     */
    FormValidation.prototype.isValidInput = function($input){
        var self = this,
            value = $.trim($input.val());

        if (!value) {
            self.setError($input, 'Empty');
            return false;
        }

        if (($input.hasClass('type-email')) && !self.isValidEmail(value)){
            self.setError($input, 'Email is not valid');
            return false;
        }
        return true;
    };
     ...
     */
    FormValidation.prototype.setErrors = function(errors){
        var self = this;

        errors.forEach(function(item){
            var $currentInput = self.$inputs.filter('[name="' + item.name + '"]').first();
     ...
     * @param {jQuery} $input
     */
    FormValidation.prototype.removeError = function($input){
        var $parent = $input.parent(),
            $error = $parent.find('b-error');
     ...
     * @param {jQuery} errors
     */
    FormValidation.prototype.removeErrors = function(){
        var self = this;
    ...
    App.widgets.FormValidation = FormValidation;
