 ...
 */
private[models] class EvaluationImpressions(tag: Tag)
    extends Table[EvaluationImpression](tag, "EVALUATION_IMPRESSION") {
  ...
  def * = (language, score0, score1, score2, score3, score4, score5,
    score6, score7, score8, score9, score10) <> (EvaluationImpression.tupled, EvaluationImpression.unapply)
