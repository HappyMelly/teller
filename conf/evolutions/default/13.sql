...
insert into PERSON (ID, FIRST_NAME, LAST_NAME, EMAIL_ADDRESS, STREET_1, CITY, POST_CODE, COUNTRY_CODE, BIO, INTERESTS, TWITTER_HANDLE, FACEBOOK_URL, LINKEDIN_URL, GOOGLE_PLUS_URL, BOARD_MEMBER, STAKEHOLDER, CREATED, CREATED_BY)
values (22, 'Jurgen', 'Appelo', 'jurgen@noop.nl', 'Palais Royal', 'Brussels', '1000', 'BE', 'Jurgen Appelo is a writer, speaker, trainer, entrepreneur, illustrator, developer, manager, blogger, reader, dreamer, leader, freethinker, and… _Dutch guy_.
